...
public class JDialog_Deposit extends JDialog
{
	...
	public JDialog_Deposit(CardFrm parent, String aname, String accountNumber)
	{
		super(parent);
		parentframe=parent;
		name=aname;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		parentframe.creditCardAccountService.deposit(accountNumber, new BigDecimal(JTextField_Deposit.getText()));
