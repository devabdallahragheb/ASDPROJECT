...
public class JDialog_Withdraw extends JDialog
{
	...
	public JDialog_Withdraw(CardFrm parent, String aname, String accountNumber)
	{
		super(parent);
		parentframe=parent;
		name=aname;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		parentframe.creditCardAccountService.withdraw(accountNumber, new BigDecimal(JTextField_AMT.getText()));
